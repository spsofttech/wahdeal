                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="col-sm-12" style="text-align: right; margin-top:10px;">
                                <a href="{{ route('admin.add_product') }}"><button
...
<script>
    ...
    $('#example1').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "{{ route('admin.product_list') }}", // Your AJAX URL
            "type": "GET",
            "data": function(d) {
...
function changestatus(id) {
    ...
    $.ajax({
        url: "{{ route('admin.product_status_change') }}",
        type: "POST",
        data: {
            _token: csrfToken,
            id: id,
...
function change_promote_status(id) {
    let csrfToken = $('meta[name="csrf-token"]').attr('content');
    $.ajax({
        url: "{{ route('admin.change_product_promote_status') }}",
        type: "POST",
        data: {
            _token: csrfToken,
            id: id,
