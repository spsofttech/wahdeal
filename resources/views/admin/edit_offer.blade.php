                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="offer_type" id="offer_type" required>
                                                ...
                                                @foreach($ot as $val)
                                                <option value="{{$val->id}}" {{ $offer->offer_type == $val->id ?
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="product_id" id="product" required
                                                ...
                                                <option value="{{$val->id}}" {{ $offer->product_id == $val->id ?
                                                    'selected' : '' }}>{{$val->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                placeholder="Enter Title" required value="{{$offer->title}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="discount_type" id="discount_type">
                                                ...
                                                <option value="percentage" {{ $offer->discount_type == 'percentage' ?
                                                    'selected' : '' }}>Percentage</option>
                                                <option value="fixed" {{ $offer->discount_type == 'fixed' ?
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" step="any" class="form-control" name="discount_value"
                                                placeholder="Enter Title" value="{{$offer->discount_value}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" name="start_date"
                                                placeholder="Enter Start Date" required value="{{$offer->start_date}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" name="end_date"
                                                placeholder="Enter End Date" required value="{{$offer->end_date}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="branch[]" id="branch" required multiple>
                                                ...
                                                <option value="{{ $val->id }}" {{ in_array($val->id, $ob) ? 'selected' :
                                                    '' }}>
