                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="col-sm-12" style="text-align: right; margin-top:10px;">
                                <a href="{{ route('admin.add_feed') }}"><button class="btn btn-primary right-align">Add
                                    </button></a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
...
$(document).ready(function() {
    $('#example1').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "{{ route('admin.feed_list') }}", // Your AJAX URL
            "type": "GET",
            "data": function(d) {
...
function changestatus(id) {
    ...
    $.ajax({
        url: "{{ route('admin.feed_status_change') }}",
        type: "POST",
        data: {
            _token: csrfToken,
            id: id,
