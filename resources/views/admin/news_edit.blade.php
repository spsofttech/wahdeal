                            ...
                            <form id="registerForm" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="{{ asset('uploads/news/' . ($news->image ?? 'logo.png')) }}"
                                            style="width:100px">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description"
                                            placeholder="Enter Description" required>{{ $news->description }}</textarea>
                                    </div>


                                    <div class="form-group">
                                        <label for="title" class="form-label">Is Highlight</label>
                                        <label class="switch"><input type="checkbox" name="ishighlight"
                                                {{ $news->is_highlight == '1' ? "checked" : '' }}><span
