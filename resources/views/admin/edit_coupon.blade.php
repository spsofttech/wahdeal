                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="code" name="code"
                                                placeholder="Enter Code" required value="{{$coupon->code}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title"
                                                placeholder="Enter Title" required value="{{$coupon->title}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="discount_type" required
                                                ...
                                                <option value="percentage" @if($coupon->discount_type == 'percentage')
                                                    selected
                                                    @endif>percentage</option>
                                                <option value="fixed" @if($coupon->discount_type == 'fixed')
                                                    selected
                                                    @endif>fixed</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" id="end_date" name="end_date"
                                                placeholder="Enter End Date" required value="{{$coupon->end_date}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="type" required id="type">
                                                ...
                                                <option value="2" @if($coupon->type == '2')
                                                    selected
                                                    @endif>Online</option>
                                                <option value="3" @if($coupon->type == '3')
                                                    selected
                                                    @endif>Subscription</option>
                                                <option value="4" @if($coupon->type == '4')
                                                    selected
                                                    @endif>Booking</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <br>
                                            <img src="{{ asset('uploads/coupon/' . ($coupon->image ?? 'logo.png')) }}"
                                                style="width:50px">
                                        </div>
