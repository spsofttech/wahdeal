                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="col-sm-12" style="text-align: right; margin-top:10px;">
                                <a href="{{ route('admin.add_offer') }}"><button class="btn btn-primary right-align">Add
                                    </button></a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
...
<script>
    ...
    $('#example1').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "{{ route('admin.offer_list') }}", // Your AJAX URL
            "type": "GET",
            "data": function(d) {
        ...
        "columnDefs": [{
            ...
            {
            "targets": 10, // Index of the 'status' column (0-based, so 6 refers to the 7th column)
            "orderable": false // Disable sorting for this column
            }
        ]
    });
...
function changestatus(id) {
    ...
    $.ajax({
        url: "{{ route('admin.offer_status_change') }}",
        type: "POST",
        data: {
            _token: csrfToken,
            id: id,
