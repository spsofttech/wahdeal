                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" id="description" name="description"
                                            placeholder="Enter Description">{{$about}}</textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" class="form-control" name="email"
                                                placeholder="Enter Email" value="{{ $oldbranch->email }}" readonly>
                                        </div>
                                        ...
                                        <div class="col-md-2 text-center" id="remove_menu_{{ $key }}">
                                            <img src="{{ asset('uploads/brand/'.$image) }}" class="img-thumbnail mb-2"
                                                style="width:100px;height:100px;"><br>
                                            <input type="hidden" name="old_menu_images[]" value="{{ $image }}">
                                        ...
                                        @php
                                        $galleryimages = isset($gallery) ? $gallery['images'] ?? [] : [];
                                        @endphp

                                        @if(!empty($galleryimages))
                                        @foreach($galleryimages as $key => $image)
                                        <div class="col-md-2 text-center" id="remove_gallery_{{ $key }}">
                                            <img src="{{ asset('uploads/brand/'.$image) }}" class="img-thumbnail mb-2"
                                                style="width:100px;height:100px;"><br>
                                            <input type="hidden" name="old_gallery_images[]" value="{{ $image }}">
                                            <button type="button" class="btn btn-danger btn-sm deleteMenu"
                                                onclick="deletegallery('{{ $key }}')">Delete</button>
                                        </div>
                                        @endforeach
                                        @endif
